            ...
            if($email == NULL){
                ...
                if($stmt->rowCount() > 0 ){
                    ...
                    exit;
                        ...
                        echo "<script>alert('We send the OTP to $email'); window.location.href = '../../../verify-otp.php;<script>";
                ...
                $subject = "VREIFICATION SUCCESS";
                        ...
                        <body>
                            <div class='container' >
                                ...
                                <p>Welcome to Sarmiento & Bangit</p>
                ...
                if ($userRow->rowCount() == 1){
                    if($userRow['status' == "active"]){
                        if($userRow ['password'] == md5($password)){
                            ...
                            echo "<script>alert('Password iss incorrect'); window.location.href = '../';</script>";
                            exit;
        
                        }
                    }else{
                            echo "<script>alert('Enterd email is not verify'); window.location.href = '../';</script>";
                            exit;
                        }
                }else  {
